...
const Privacy = () => (
  <div className="layout__privacy">
    ...
    <p>
      ...
      pages and other statistics. In addition, we may use third party services such as Google Analytics that collect, monitor and analyze this information to improve our platform.
    </p>
    <p>
